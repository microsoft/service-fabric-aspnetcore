...
namespace Microsoft.ServiceFabric.Services.Communication.AspNetCore
{
    ...
    /// </summary>
    public class WebListenerCommunicationListener : AspNetCoreCommunicationListener
    {
        private readonly string endpointName;

        /// <summary>
        /// Initializes a new instance of the <see cref="WebListenerCommunicationListener"/> class.
        /// </summary>
        ...
        public WebListenerCommunicationListener(ServiceContext serviceContext, string endpointName, Func<string, AspNetCoreCommunicationListener, IWebHost> build)
